...
public class MemberVO {
	@NotBlank(groups= {MemberRegistGroup.class, MemberLoginGroup.class}, message = "이메일을 입력해주세요.")
	...
	private String name;
	@NotBlank(groups= {MemberRegistGroup.class, MemberLoginGroup.class}, message = "비밀번호를 입력해주세요.")
	@Size( groups= MemberRegistGroup.class, min = 10, message = "비밀번호는 최소 10자리 이상 입력해주세요.")
	private String password;
	@NotBlank( groups= MemberRegistGroup.class, message = "비밀번호 확인을 입력해주세요.")
