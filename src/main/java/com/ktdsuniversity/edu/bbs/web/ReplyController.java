...
public class ReplyController {
	...
	public Map<String, Object> doCreateNewReplies(@PathVariable int boardId,
		...
		System.out.println("email: "+ replyVO.getEmail());
	...
	public Map<String, Object> doDeleteOneReply(@PathVariable int replyId,
												@SessionAttribute("_LOGIN_USER_") MemberVO memberVO) {
	...
	public Map<String, Object> doRecomendReplies(@PathVariable int replyId,
												 @SessionAttribute("_LOGIN_USER_") MemberVO memberVO) {
		boolean isSuccess = replyService.recomendOneReply(replyId, memberVO.getEmail());
